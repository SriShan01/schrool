      ...
      {isLoading ? (
        ...
        <div className="w-full 1000px:flex items-center">
          ...
          <div className="1000px:w-[60%] flex flex-col items-center 1000px:mt-[0px] text-center 1000px:text-left mt-[150px]">
            <h2 className="dark:text-white text-[#000000c7] text-[32px] px-3 w-full 1000px:text-[32px] font-[600] font-Josefin py-2 1000px:leading-[75px] 1500px:w-[60%] 1100px:w-[78%]">
              {/* {data?.layout?.banner?.title} */}
              SCHROOL, A PLACE WHERE PARENTS FIND REAL SOLUTIONS FOR CHILDREN
              STRUGGLING WITH MATH.
            </h2>
            <br />
            <p className="dark:text-[#edfff4] text-[#000000ac] font-Josefin font-[600] text-[18px] 1500px:!w-[55%] 1100px:!w-[78%]">
              {/* {data?.layout?.banner?.subTitle} */}A time- tested learning
              system which allows you to instantly pinpoint, diagnose and fix
              the root causes of your child’s math shortcomings, empowering you
              to take control, oversee and guide your child to heights you only
              dreamt about.
            </p>
            <br />
            <br />
